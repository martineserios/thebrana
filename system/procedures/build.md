...
Read and follow [`../skills/_shared/challenger-gate.md`](../skills/_shared/challenger-gate.md) — the full shared gate: invocation rules, input contract, spawn call, blocking rules, and repair loop (max 2 iterations).
...
Run the Challenger Gate before CLOSE. Read and follow [`../skills/_shared/challenger-gate.md`](../skills/_shared/challenger-gate.md) — bug fixes use the same invocation rules, input contract, and repair loop.
...
Run the Challenger Gate before CLOSE. Read and follow [`../skills/_shared/challenger-gate.md`](../skills/_shared/challenger-gate.md) — refactors use the same invocation rules, input contract, and repair loop.
