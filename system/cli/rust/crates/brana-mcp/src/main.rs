...
async fn main() -> anyhow::Result<()> {
    let server = pmcp::Server::builder()
        ...
        .tool("backlog_ac_approve", tools::backlog_ac_approve::build())
        ...
        .tool("backlog_wave_add", tools::backlog_wave_add::build())
        ...
        .tool("backlog_wave_drain", tools::backlog_wave_drain::build())
