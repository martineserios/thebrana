...
# ── 11. dedup key embeds learning type (t-1979 #2) ─────────────────────
...
# ── 12. categorized failure reasons (t-1979 #4) ────────────────────────
...
# ── 13. confidence filter + cap 3 (t-1979 #7) ──────────────────────────
...
# ── 14. weekly unrouted-learnings reminder (t-1979 #8) ─────────────────
...
# ── 15. defensive snapshot sweep — age-based, status-blind (t-1979 #5) ──
...
# ── 16. daily-summary 30d prune (t-1979 #9) ────────────────────────────
...
# ── 17. cron preamble exports HOME (t-1979 #6) ─────────────────────────
check "cron exports HOME explicitly" "1" "$(grep -c '^export HOME' "$CRON")"

# ── 18. extraction prompt is a versioned file (t-1979 #7) ──────────────
