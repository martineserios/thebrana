...
# Actions: (1) validate JSON (2) validate schema (3) auto-rollup parents
...
# Find completed tasks, check if all siblings of their parent are done
ROLLUP_NEEDED=$(jq -r '
  # Build lookup of parent -> children
