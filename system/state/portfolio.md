...
### truper
- **Type:** Hybrid — moneyless barter marketplace. People publish things they have and ask for things they want; the platform joins the two sides. No currency; multi-item exchanges allowed. Name from *trueque* + *permuta*
- **Location:** `~/enter_thebrana/ventures/truper/`
- **Remote:** `https://github.com/martineserios/truper` (private)
- **Stack:** not chosen yet
- **Status:** Starting — 2026-07-29. Scaffolded via `/brana:onboard new`. Concept source: `docs/concept-source.md`. Open design questions (matching chains, valuation without money, trust/disputes) captured there — nothing decided yet
