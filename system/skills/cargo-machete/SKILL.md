...
task_strategies: [refactor, tech-debt]
...
For CI integration patterns, configuration file examples, pre-commit setup, and Makefile integration, see the `cargo-machete` documentation.
