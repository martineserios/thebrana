...
description: "Think beyond immediate consequences to second- and third-order effects — Howard Marks' investment framework. Use for strategic calls, policy/rule changes, or competitive moves where the obvious answer may backfire."
group: thinking
keywords: [second-order, consequences, strategy]
allowed-tools: [Read, Glob, Grep, AskUserQuestion]
status: acquired
source: "https://skills.sh/guia-matthieu/clawfu-skills/second-order-thinking"
acquired: "2026-08-04"
quarantine: true
---
