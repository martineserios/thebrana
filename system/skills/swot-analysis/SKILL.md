---
name: swot-analysis
description: "Perform a SWOT/FODA analysis — strengths, weaknesses, opportunities, threats with actionable recommendations. Use for strategic assessment, competitive analysis, evaluating a product/business/project position, or when deciding between strategic directions."
group: thinking
keywords: [swot, foda, strategic-analysis, competitive-analysis, strengths, weaknesses, opportunities, threats, strategy]
allowed-tools:
  - Read
  - Glob
  - Grep
...
## Input Requirements
- Product/project/business description and current state
