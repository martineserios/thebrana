...
description: "Critically analyse written content — articles, proposals, arguments, reports. Identify core claims, spot logical fallacies, surface hidden assumptions, flag what's missing. Use when reviewing external docs, evaluating reasoning quality, or stress-testing an argument before acting on it."
group: thinking
keywords: [critical-thinking, logical-reasoning, argument-analysis, fallacies, assumptions, proposals, articles]
allowed-tools:
  - Read
  - Glob
  - Grep
