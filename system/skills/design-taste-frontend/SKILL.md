...
description: "Anti-slop frontend skill for landing pages, portfolios, redesigns — infers the design direction and ships interfaces that don't look templated. Real design systems when applicable, audit-first, strict pre-flight."
group: frontend
keywords: [ux, ui, design, frontend, landing, anti-slop]
allowed-tools: [Read, Glob, Grep, AskUserQuestion]
status: acquired
source: "https://skills.sh/leonxlnx/taste-skill/design-taste-frontend"
acquired: "2026-08-04"
quarantine: true
---
