<!-- close phase: Steps 1 (continued)-3b: close-mode orientation, snapshot+queue, gather evidence, extract+classify findings, doc-update check — continues from gate-and-evidence.md's Step 1; loaded per the PHASES registry in ../SKILL.md (t-1942) -->

## Steps (continued from gate-and-evidence.md)
