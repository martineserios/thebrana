...
description: "Break down complex problems to fundamental truths, then reason up — Aristotle's method as modernized by Elon Musk. Use when a problem looks impossible or to challenge an assumed industry constraint."
group: thinking
keywords: [first-principles, decomposition, reasoning]
allowed-tools: [Read, Glob, Grep, AskUserQuestion]
status: acquired
source: "https://skills.sh/guia-matthieu/clawfu-skills/first-principles"
acquired: "2026-08-04"
quarantine: true
---
