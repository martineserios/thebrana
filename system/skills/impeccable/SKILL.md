---
name: impeccable
description: "Use when designing, redesigning, critiquing, auditing, or polishing a frontend interface — sites, dashboards, product UI, forms, onboarding, empty states. Covers UX, visual hierarchy, IA, cognitive load, accessibility."
group: frontend
keywords: [ux, ui, polish, audit, frontend, design]
