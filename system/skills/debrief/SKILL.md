...
- "Run `/maintain-specs` to propagate these findings through the spec docs (re-evaluate reflections, apply errata layer by layer, update [doc 25](25-self-documentation.md))."
