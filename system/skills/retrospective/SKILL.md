---
name: retrospective
description: Store a learning in the memory taxonomy — classify by type (Rule/Pattern/Knowledge/Decision/Reference), route to canonical destination. Use after notable discoveries, unexpected issues, successful workarounds, or when a reusable pattern emerges.
effort: low
