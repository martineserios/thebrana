...
Read and execute `../../procedures/brainstorm.md` resolved against this skill's base directory (the path announced when the skill loads) — i.e. `{base-dir}/../../procedures/brainstorm.md`. This form is valid in both the repo layout and the deployed-plugin layout.
