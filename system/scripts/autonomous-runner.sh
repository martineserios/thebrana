...
# resolve_claude / stage_runner_home / sandbox_claude now live in
# system/scripts/lib/sandbox-claude.sh (t-3317) — shared with feed-summarize.sh so the
# bwrap capability jail has exactly one implementation instead of two that can drift.
