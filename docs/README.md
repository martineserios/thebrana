...
| File | What It Covers |
|------|---------------|
| `docs/decisions/ADR-001-reconcile-command-for-spec-implementation-drift.md` | Reconcile command for spec-to-implementation drift remediation |
...
- **Corrections:** Read `24` for errors found in docs 14, 17, 18 during Phase 2 planning — must-fix items before implementing hooks
