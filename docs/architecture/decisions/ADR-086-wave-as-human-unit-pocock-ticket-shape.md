...
| T4 (**t-3162**) | ✅ **shipped 2026-08-29** — `CHECK:` lines parsed against vocabulary v1 (probe A1 `CHECK-EXEMPT:` + A2 prose band included; parser `brana-cli/src/commands/wave_check.rs`); `wave ship` evaluates-and-shows then flips (operator decision 2026-08-29: display never gates — red check informs, human's invocation ships); `contract` runner-denied (hook + tests); D2/D5 amended | M | backlog-v3-schema D2/D5, runner-verb-guard.sh |
