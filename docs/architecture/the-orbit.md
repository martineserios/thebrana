...
| Doc | Status |
|-----|--------|
| [../ideas/drained/runner-capability-isolation.md](../ideas/drained/runner-capability-isolation.md) | Sandbox the Orbit's executor — bwrap capability isolation (idea, t-2173; HARD precondition for unattended runs) |
