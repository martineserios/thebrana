...
Brana has 37+ skills — `/tasks`, `/research`, `/build-phase`, etc. Before this feature, there was no way to know which skills were actually being used, how often, or which ones were dead weight.
