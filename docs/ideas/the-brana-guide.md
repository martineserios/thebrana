...
relates-to:
  ...
  - "[ADR-068](../architecture/decisions/ADR-068-v3-supersession.md) — retirement of Substrate/Orbit vocabulary; open Q1 = the front door this guide becomes"
  - "[brana-etymology-naming](../../../brana-knowledge/dimensions/brana-etymology-naming.md) — brane physics = the one lens"
---
> **START HERE (next session):** we are at **L0.1 — the cover paragraph**. Read L0 fully, then reply to the draft cover in the last assistant message of session 9a26bc54 (or re-draft). Do not descend below a node until it is ✅. Persisted here 2026-08-18 by session thebrana-50; scratchpad copies are dead.
...
**OPEN** ▢
- ▢ L0.1 Cover paragraph. `[→ the-brana.md §cover]`
- ▢ L0.2 Which brane mappings go on the cover vs stay chapter pictures: bulk / brane / fields / gravity-leak / open-closed strings / KK dimensions⇄frequencies / RS warped scales / compactification. `[brana-etymology-naming.md · wave-pipeline.md §rings · 60-agent-loop-architecture.md]`
- ▢ L0.3 Board decisions D1–D5: accept ADR-068 · renumber t-2980's ADR → 086 · absorb wave-pipeline.md (+redirect stub, tag sweep) · front door · tidy scope (cluster now, README sweep separate). `[ADR-068 · the three worktree ADRs · wave-pipeline.md · docs/README.md (19 ADRs + 41 features missing, 2 dead rows)]`
