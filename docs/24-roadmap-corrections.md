...
|---|---|---|---|---|
| E2026-05-06-6 | batrade: ADR-002 §47 + modelo-datos.md §960 still hardcode OpenAI/GPT-4o-mini — LLM provider is TBD | **Low** | pending | solucion-tecnica.md + CLAUDE.md updated this session, but ADR-002 §47 ("Default provider: OpenAI GPT-4o-mini") and modelo-datos.md §960 example (`openai/gpt-4o-mini`) missed. Fix: ADR-002 §47 → "provider/model TBD (env vars)"; modelo-datos §960 → `<provider>/<model>`. Same multi-doc consistency class as scope-change pattern. |
