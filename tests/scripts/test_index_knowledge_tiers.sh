...
assert "tags contain tier:semantic" "true" "$([[ "$TAGS" == *"tier:semantic"* ]] && echo true || echo false)"
assert "tags contain type:dimension" "true" "$([[ "$TAGS" == *"type:dimension"* ]] && echo true || echo false)"
