...
echo ""
echo "  DEPRECATED: deploy.sh is replaced by the plugin system."
echo "  Use:  claude --plugin-dir ./system   (dev mode)"
echo "  Or:   /plugin marketplace add martineserios/thebrana  (install)"
echo "  Identity layer (CLAUDE.md, rules, scripts): ./bootstrap.sh"
echo ""
echo "  This script still works but will be removed in v0.8.0."
echo ""
echo "=== Brana Deploy ==="
